...
def run_tests():
    ...
    # Check if the customized fuel values are set correctly.
...
def format_sentence(phrase):
    ...
    'This is a test.'
    """
    # Capitalize the first letter of the input phrase.
    sentence = phrase.capitalize()
    # Check if the processed phrase has already ended with a period. If not, add a period at the end.
