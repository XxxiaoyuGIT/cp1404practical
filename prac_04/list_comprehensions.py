...
a_names = [name for I in names if I.startswith('A')]
print(a_names)
...
greater = [number for number in numbers if number>9]
print(greater)
...
long_name = [name.split()[1] for name in full_names if len(name)>11]
print(", ".join(sorted(long_name)))