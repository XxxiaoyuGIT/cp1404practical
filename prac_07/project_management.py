...
def load_projects(filename):
    ...
    with open(filename, 'r') as f:
        ...
        for line in f:
            ...
            projects.append(Projects(name, start_date, priority, cost_estimate, completion_percentage))
    return projects
...
def add_new_project():
    ...
    return Projects(name, start_date, priority, cost_estimate, completion_percentage)
...
def save_projects(filename, projects):
    with open(filename, 'w') as f:
        f.write("Name\tStart Date\tPriority\tCost_Estimate\tCompletion_Percentage\n")
